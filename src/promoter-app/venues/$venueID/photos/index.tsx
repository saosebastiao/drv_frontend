...
interface PEditPhotos extends RouteComponentProps<{}> {
  model: ShowVenueModel;
}

@observer
export default class EditPhotos extends React.Component<PEditPhotos> {
  public venue = new EditPhotosModel(this.props.model.venueID);
